...
int gw_decompress_to_simple_fil(int encodeMethod, const char *inbuf, size_t inlen, struct ci_simple_file *outfile, ci_off_t max_size)
{
#if defined(HAVE_CICAP_DECOMPRESS_TO)
    return ci_decompress_to_simple_file(encodeMethod, inbuf, inlen, outfile, max_size);
#else
...
int gw_decompress_simple_file(int encodeMethod, const char *inbuf, size_t inlen, struct ci_simple_file *outfile, ci_off_t max_size)
{
#if defined(HAVE_CICAP_DECOMPRESS_TO)
    return ci_decompress_to_simple_file(encodeMethod, inbuf, inlen, outfile, max_size);
#else
...
int gw_decompress_wwwto_simple_file(int encodeMethod, const char *inbuf, size_t inlen, struct ci_simple_file *outfile, ci_off_t max_size)
{
#if defined(HAVE_CICAP_DECOMPRESS_TO)
    return ci_decompress_to_simple_file(encodeMethod, inbuf, inlen, outfile, max_size);
#else
...
int gw_decompressrr_to_simple_fil(int encodeMethod, const char *inbuf, size_t inlen, struct ci_simple_file *outfile, ci_off_t max_size)
{
#if defined(HAVE_CICAP_DECOMPRESS_TO)
    return ci_decompress_to_simple_file(encodeMethod, inbuf, inlen, outfile, max_size);
#else
...
int gw_decompresss_simple_file(int encodeMethod, const char *inbuf, size_t inlen, struct ci_simple_file *outfile, ci_off_t max_size)
{
#if defined(HAVE_CICAP_DECOMPRESS_TO)
    return ci_decompress_to_simple_file(encodeMethod, inbuf, inlen, outfile, max_size);
#else
